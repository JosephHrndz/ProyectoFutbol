 ...
 * @author MINEDUCYT
 */
public class ResultadosPremier {
   private int id;
   ...
   private int top_aux;
    ...
    public ResultadosPremier() {
    }

    public ResultadosPremier(int id, String equipo1, String resultadoDeportes, String equipo2, int top_aux) {
        this.id = id;
